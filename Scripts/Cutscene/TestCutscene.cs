...
public class TestCutscene : Node2D
{
        ...
        switch (stage) {
            ...
            case CutsceneStage.FadeIn:
                if (fadeToBlack.Color.a == 0.0) {
                    scrollingText.BeginTextBuffer("This is test message 1.");
                    stage = CutsceneStage.DisplayText1;
                }
                break;
            case CutsceneStage.DisplayText1:
                if (scrollingText.PlayerExited) {
                    SetColor(new Color(.5f,0,0));
                    scrollingText.BeginTextBuffer("This is test message 2.");
