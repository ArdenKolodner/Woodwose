...
public class IronCutscene : Node2D
{
        ...
        switch (stage) {
            ...
            case CutsceneStage.FadeIn:
                if (fadeToBlack.Color.a == 0.0) {
                    ...
                    scrollingText.BeginTextBuffer("You remember a figure of authority -- a tutor, perhaps? -- instructing you before a glowing smithy, a long time ago.");
            ...
            case CutsceneStage.DisplayText1:
                if (scrollingText.PlayerExited) {
                    ...
                    SetColor(new Color(.3f,.3f,.3f));
                    scrollingText.BeginTextBuffer("Remember always the code of chivalry. For it is not just the foundation of our society, but of order and virtue itself.");
                    stage = CutsceneStage.DisplayText2;
                }
                break;
            case CutsceneStage.DisplayText2:
                if (scrollingText.PlayerExited) {
                    scrollingText.BeginTextBuffer("Learn to follow its rules, and your willpower will know no equal.");
                    stage = CutsceneStage.DisplayText3;
                }
                break;
            case CutsceneStage.DisplayText3:
                if (scrollingText.PlayerExited) {
                    scrollingText.BeginTextBuffer("When you don your mail of iron and draw your iron sword, let your mind be of iron as well.");
            ...
            case CutsceneStage.DisplayText4:
                if (scrollingText.PlayerExited) {
                    ...
                    scrollingText.BeginTextBuffer("I will try, sir.");
            ...
            case CutsceneStage.DisplayText5:
                if (scrollingText.PlayerExited) {
                    scrollingText.SetAudio(voices.sideCharacterVoice);
                    SetColor(new Color(.3f,.3f,.3f));
                    scrollingText.BeginTextBuffer("Good. Now, back to your books. You should have finished De Amore by now.");
                    stage = CutsceneStage.DisplayText6;
                }
                break;
            case CutsceneStage.DisplayText6:
                if (scrollingText.PlayerExited) {
                    scrollingText.BeginTextBuffer("Learn it well -- I sense you will have need of its wisdom soon enough, my boy.");
